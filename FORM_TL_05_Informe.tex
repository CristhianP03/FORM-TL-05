...
En cumplimiento con las políticas de transparencia e integridad académica, se declara el uso asistido de Inteligencia Artificial Generativa durante el desarrollo del informe, especificando el alcance exacto de dicho apoyo:
...
\begin{itemize}
    ...
    \item \textbf{Lo que la IA \emph{no} realizó:} la ejecución de las calculadoras oficiales de costos, el análisis técnico de los criterios de selección la decisión final de proveedor y la redacción del ADR-001 fueron realizadas y validadas directamente por los integrantes del equipo, con base en criterio propio.
\end{itemize}
